...
public class MainPanel extends JPanel {
	...
	public boolean iterateCell(int x, int y) {			//One of the methods to refactor
	...
	//	int c = 0;	//Pretty sure this while loop section is useless
	//	String padding = "0";
	//	while (c < r * 10) {
	...
	public void calculateNextIteration() {			//2nd method to refactor
